...
class PaymentProductFieldDisplayHints {
  ...
  const PaymentProductFieldDisplayHints.empty(
      ...
      this.link = "",
      this.mask = "",
      this.preferredInputType = PreferredInputType.stringKeyboard,
      this.tooltip,
      this.formElement});

  factory PaymentProductFieldDisplayHints.fromJson(Map<String, dynamic> json) {
    if (json['alwaysShow'] == null) {
      return const PaymentProductFieldDisplayHints.empty();
    } else {
      return _$PaymentProductFieldDisplayHintsFromJson(json);
    }
  }
